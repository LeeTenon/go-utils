...
var (
    ErrInitial = errors.New("id.snowflake: initial error")
    ErrGen     = errors.New("id.snowflake: gen error")
)
...
var defaultOption = Option{
    ...
    WorkerIdBits:     5,
    SequenceBits:     12,
    Epoch:            int64(1288834974657), // 对应现实时间： 2010/11/4 9:42:54.657
...
//New return work node
//  dataCenterId 和 workerId 的取值范围取决于 DataCenterIdBits 和 WorkerIdBits
func New(dataCenterId int, workerId int, modOptions ...

    ModOption) (*Node, error) {
